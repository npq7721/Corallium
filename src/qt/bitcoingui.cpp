                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Corallium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CRLM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and corallium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Corallium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Corallium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Corallium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CRLM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CRLM addresses"));
    ...
    openAction->setStatusTip(tr("Open a corallium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Corallium Core help message to get a list with possible Corallium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Corallium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Corallium network", "", count));
}
...
{
    QString strTitle = tr("Corallium Core"); // default title
