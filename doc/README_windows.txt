...
Intro
-----
Corallium (CRLM) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Corallium utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run corallium-qt.exe.

Corallium Core is the original Corallium client and it builds the backbone of the network.
However, it downloads and stores the entire history of Corallium transactions;
